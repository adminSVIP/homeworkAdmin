            ...
            <div class="x_content">
                    ...
                    <div class="row dropdown">
                        ...
                        <ul class="dropdown-menu pull-left" style="position: relative;top: 0;" aria-labelledby="dropdownMenu1">
                            <span class="col-md-12 " style="padding: 0" ng-repeat="type in types">
                                <li id={{type.id}} ng-click="clickType(type)"><a class="col-md-7">{{type.name}}</a></li><span
                                    class="glyphicon glyphicon-plus" style="line-height: 20px;" aria-hidden="true"></span>
                            </span>
                ...
                <form class="form-horizontal form-label-left  pull-left col-md-6 ">
                    ...
                    <div class="form-group">
                        ...
                        <div class=" col-md-3 col-sm-3  " style="margin-top: 5px;border-radius: 3px">
                            ...
                            <span ng-if="pqueryType=='insert'">
                                <input type="text" class="input_pType" readonly value="" id="first-pType" required="required" class="form-control col-md-7 col-xs-12">
                                <input ng-if="t.id==currProducts.type_id" type="hidden" class="hid_typeId" value="{{currProducts.type_id}}" name="type_id">
                            </span>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" id="input_price" class="input_price" name="price" value="{{currProducts.price}}" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                    </div>
                    <div class="form-group">
